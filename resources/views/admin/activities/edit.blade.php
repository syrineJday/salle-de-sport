                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.activities.update', ['activity' => $activity]) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-6 position-relative">
                                    <input type="text" class="form-control @error('prixSeance') input-invalid @enderror" value="{{ $activity->prixSeance }}" name="prixSeance" placeholder="Saisir prix de séance d'activité" id="prixSeance">
                                    @error('prixSeance')
                                        <div class="invalid-tooltip  d-block ">
                                            {{ $message }}
                                        </div>
