...
<li class="nav-item">
    <a class="nav-link @if(Request::is('admin/abonnes') || Request::is('admin/entraineur')) @else collapsed @endif" data-bs-target="#forms-nav" data-bs-toggle="collapse" href="#" aria-expanded="false">
...
<li class="nav-item">
    <a class="nav-link @if(Request::is('admin/activites')) @else collapsed @endif" href="{{ url('admin/activites') }}">
        <i class="bi bi-grid"></i>
        <span>Activités</span>
    </a>
</li>
